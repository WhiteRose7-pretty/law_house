<template>
    <div class="game">
        <h1 v-if="!game">Nowa Gra</h1>
        <h1 v-else>Nowy etap - {{game.name}}</h1>
                ...
                <div v-if="sets">
                    ...
                    <div v-for="s in sets">
                        <div v-if="s.group">
                            ...
                            <div v-bind:id="'group-'+s.index" style="display:none; padding:8px 5px; padding-left:25px;">
                                <div v-for="ss in s.list">
                                    ...
                                    <div v-bind:id="'elements-tree-'+ss.id" v-if="elements"
                                         class="mt-3 ml-3 overflow-auto" style="display:none;">
                                        <v-jstree v-if="elements" :data="legal_tree(ss.legal_id)" show-checkbox multiple
                        ...
                        <div v-else style="padding:8px 5px;">
                            <div class="mdc-form-field cursor-pointer max-width-85" v-on:click="setSelect(s.id)">
                                ...
                                <label class="m-0" v-bind:for="'set-checkbox-'+s.id">{{s.name}} ({{s.total}})</label>
                            </div>
                    ...
                    <div>
                        <div v-for="item in admin_tests">
                            <div class="mdc-form-field cursor-pointer max-width-85">
                                <div class="mdc-checkbox">
                                    <input type="checkbox" :id="'admin-test-'+item.id"
                                           class="mdc-checkbox__native-control set-select"
                                ...
                                <label :for="'admin-test-'+item.id" class="m-0">{{ item.name }}
                                    ({{item.counts_of_questions}})</label>
                            </div>
                        </div>
                        <div>
                        </div>
                        ...
                        <div>
                            <div class="mb-3">
                                <select v-if="!game" v-model="settings.type" class="form-control form-control-lg">
                                    <option value="">Wybierz typ rozgrywki</option>
                                    <option value="exam">Egzamin</option>
                                    <option value="race">Wyścig</option>
                                </select>
                                <select v-else v-model="settings.type" class="form-control form-control-lg"
                                        disabled="disabled">
                                    <option value="">Wybierz typ rozgrywki</option>
                                    <option value="exam">Egzamin</option>
                                    <option value="race">Wyścig</option>
                            ...
                            <div v-if="settings.type" class="mb-3">
                                <select v-model="settings.limit" class="form-control form-control-lg">
                                    <option v-for="t in 15" v-bind:value="10*t">{{10*t}} pytań.</option>
                                </select>
                            </div>
                            <div v-if="settings.type == 'exam'" class="mb-3">
                                <select v-model="settings.time" class="form-control form-control-lg">
                                    <option v-for="t in 15" v-bind:value="10*t">{{10*t}} min.</option>
                                </select>
                            </div>

                            <div v-if="!game && settings.type" class="row  mb-3">
                                <div class="col-3 pt-1">
                                    <div class="mdc-switch ml-2" data-mdc-auto-init="MDCSwitch"
                                         style="vertical-align:middle;">
                                        <div class="mdc-switch__track"></div>
                                        <div class="mdc-switch__thumb-underlay">
                                            <div class="mdc-switch__thumb"></div>
                                            <input type="checkbox" id="game_custom_name"
                                                   class="mdc-switch__native-control" role="switch" aria-checked=""
                                                   v-model="settings.custom_name">
                                        </div>
                                    </div>
                                    <label v-if="!settings.custom_name" for="game_custom_name"
                                           class="ml-2 pb-0 yh-fs-16 yh-v-o-70">Nazwa gry domyślna</label>
                                </div>
                                <div class="col-9" v-if="settings.custom_name">
                                    <input class="form-control form-control-lg" v-model="settings.name"
                            ...
                            <div v-if="!game && settings.type" class="row mb-3">
                                <div class="col-3 pt-1">
                                    <div class="mdc-switch ml-2" data-mdc-auto-init="MDCSwitch"
                                        ...
                                        <div class="mdc-switch__thumb-underlay">
                                            <div class="mdc-switch__thumb"></div>
                                            <input type="checkbox" id="game_start_time"
                                                   class="mdc-switch__native-control" role="switch" aria-checked=""
                                                   v-model="settings.custom_time">
                                        </div>
                                    </div>
                                    <label v-if="!settings.custom_time" for="game_start_time"
                                           class="ml-2 pb-0 yh-fs-16 yh-v-o-70">Start dowolnie</label>
                                </div>
                                <div class="col-9" v-if="settings.custom_time">
                                    <!-- <input v-model="settings.starts_at" placeholder="YYYY-mm-dd HH:MM"/> -->
                                    <datetime-picker
                                        class="form-control form-control-lg"
                                        v-model="settings.starts_at"
                                        timeType="minute"
                                        v-bind:dayStr="['Nie', 'Pon', 'Wt', 'Śr', 'Cz', 'Pią', 'Sob']"
                                        btnStr="OK"
                                        v-bind:firstDayOfWeek="1"
                                        v-bind:timeStr="['Godz','Min','sek']"
                                        placeholder="Czas startu"
                                        v-bind::popperOptions="{placement: 'top-left', positionFixed: false}"
                                    ></datetime-picker>
                                </div>
                            </div>

                            <div v-if="!game && settings.type && settings.custom_time" class="row mb-3">
                                <div class="col-12 pt-1">
                                    <div class="mdc-switch ml-2" data-mdc-auto-init="MDCSwitch"
                                        ...
                                        <div class="mdc-switch__thumb-underlay">
                                            <div class="mdc-switch__thumb"></div>
                                            <input type="checkbox" id="game_auto_start"
                                                   class="mdc-switch__native-control" role="switch" aria-checked=""
                                                   v-model="settings.auto_start">
                                        </div>
                                    </div>
                                    <label for="game_auto_start" class="ml-2 pb-0 yh-fs-16 yh-v-o-70">Zacznij
                                        automatycznie o wyznaczonej porze</label>
                                </div>
                            </div>

                            <div v-if="!game && settings.type && yh.auth.user_type !== 'user'" class="row mb-3">
                                <div class="col-3 pt-1">
                                    <div class="mdc-switch ml-2" data-mdc-auto-init="MDCSwitch"
                                         style="vertical-align:middle;">
                                        <div class="mdc-switch__track"></div>
                                        <div class="mdc-switch__thumb-underlay">
                                            <div class="mdc-switch__thumb"></div>
                                            <input type="checkbox" id="game_regula" class="mdc-switch__native-control"
                                                   role="switch" aria-checked="" v-model="settings.regula">
                                        </div>
                                    </div>
                                    <label for="game_regula" class="ml-2 pb-0 yh-fs-16 yh-v-o-70">Dodaj regulamin
                                        gry</label>
                                </div>
                                <div class="col-9" v-if="settings.regula">
                                    <select v-if="!game" v-model="settings.regula_id"
                                            class="form-control form-control-sm">
                                        <option v-for="r in regulations" v-bind:value="r.id">{{r.title}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div v-if="settings.type != '' && ( settings.selected>0 || admin_tests_selected)">
                            <div v-if="settings.only_new == true">
                                <div v-if="settings.total_new > 0">
                                    ...
                                    <button v-on:click="save()" class="btn btn-primary">Utwórz i rozpocznij</button>
                                </div>
                                <div v-else>
                            ...
                            <div v-else-if="settings.only_known == true">
                                <div v-if="settings.total_known > 0">
                                    ...
                                    <button v-on:click="countQuestions()" class="btn btn-primary">przelicz pytania
                                    </button>
                                    <button v-on:click="save()" class="btn btn btn-primary">Utwórz i rozpocznij</button>
                                </div>
                                <div v-else>
                                    <h3 class="mt-3 mb-3 pt-3" style="border-top:1px #ddd dotted;">Brak możliwości
                                        stworzenia takiego testu</h3>
                            ...
                            <div v-else>
                                <div>
                                    <h3 class="mt-3 mb-3 pt-3" style="border-top:1px #ddd dotted;">Podsumowanie</h3>
                                    <p v-if="settings.type == 'exam'">
                                        Wybrałeś grę w trybie <strong>egzamin</strong>.
                                        W tej rozgrywce każdy uczestnik ma maksymalnie
                                        <strong>{{settings.time}}</strong> minut na udzielenie odpowiedzi na jak
                                        największą liczbę pytań.
                                        <br><br>
                                        Wygrywa ten kto udzieli prawidłowej odpowiedzi na największą liczbę pytań lub
                                        ten kto udzieli takiej odpowiedzi w najkrótszym czasie.
                                    </p>
                                    <p v-if="settings.type == 'race'">
                                        Wybrałeś grę w trybie <strong>wyścig</strong>.
                                        Ta rozgrywka kończy się w momencie, gdy <u>pierwszy</u> z graczy udzieli
                                        prawidłowej odpowiedzi na <u>wszystkie</u> pytania. Pytania, na które gracz
                                        odpowiedział nieprawidłowo trafiają na koniec kolejki. Będziesz mógł dodać
                                        kolejny etap po każdej zakończonej rozgrywce.
                                    </p>
                                    <p>
                                        Twoja gra będzie zawierała
                                        <span style="font-size:1.5em;">
                                    {{
                                        settings.limit == 0
                                        ?
                                    ...
                                    <p>
                                        Po utworzeniu gry będziesz mógł zaprosić do niej znajomych.
                                    </p>

                                    <button v-if="!saving" v-on:click="countQuestions()" class="btn btn-primary">
                                        przelicz pytania
                                    </button>
                                    <button v-if="!saving" v-on:click="save()" class="btn btn-primary">Utwórz</button>
                        ...
                        <div v-else>
                            <h3 class="mt-3 mb-3 pt-3 yh-v-o-60" style="border-top:1px #ddd dotted;">Wybierz zakres
                                materiału</h3>
                            <p>Żeby stworzyć nowy test musisz wybrać choć jeden zestaw pytań oraz typ rozgrywki</p>
                        </div>
...
<script>
    ...
    export default {
        ...
        created() {
            if (typeof this.$route.params.hash_key != 'undefined') {
            ...
            // var dt = new Date(+new Date() + 0.6e6);
            // this.minDate = dt.getFullYear() + '-' + (dt.getMonth() <10 ? '0' : '') + dt.getMonth() + '-' + (dt.getDate() <10 ? '0' : '') + dt.getDate() + ' ' + dt.getHours() + ':' + dt.getMinutes() + ':00';
        ...
        methods: {
            ...
            documentsFetch() {
                ...
                axios
                    .post(
                        '/api/admin/documents/chapter_all',
                        {
                            hash_id: yh.auth.hash_id,
                        }
                    )
            ...
            fetchGame() {
                ...
                axios
                    ...
                    .then(response => {
                        this.game = JSON.parse(JSON.stringify(response.data.root_game));
                        this.settings.type = 'race';
                    }).catch(error => {
                    this.loading = false;
                    this.error = error.response.data.message || error.message;
                    if (error.response.data.location) {
            ...
            fetch() {
                ...
                axios
                    ...
                    .then(response => {
                        this.regulations = JSON.parse(JSON.stringify(response.data));
                    }).catch(error => {
                    this.loading = false;
                    this.error = error.response.data.message || error.message;
                    if (error.response.data.location) {
            ...
            save() {
                ...
                axios
                    ...
                    .then(response => {
                        this.loading = false;
                        if (response.data.game.type == 'exam') {
                            this.$router.push({
                                name: 'games.view.exam',
                                params: {hash_key: response.data.game.hash_key}
                            });
                        }
                        if (response.data.game.type == 'race') {
                            if (response.data.root_game == null) {
                                this.$router.push({
                                ...
                                this.$router.push({
                                    name: 'games.view.race',
                                    params: {hash_key: response.data.root_game.hash_key, refresh: true}
                                });
                            }
